...
(function jQueryScrollspy(window, $) {
    ...
    $.fn.extend({
        scrollspy: function scrollspy(options, action) {
            ...
            // console.log(['$container', $container, options.container, this]);
            ...
            return this.each(function each() {
                ...
                $container.on('scroll.' + options.namespace, function onScroll() {
                    ...
                    var max = options.max || $element.position().top + $element.outerHeight();

                    var min = options.min || $element.position().top;
                    ...
                    // console.log(['X and Y', min, xAndY, max, containerHeight, $container]);
                    if (xAndY >= min && xAndY <= max) {
                        ...
                        if (inside) {
                            ...
                            // console.log(['elementHeight', elementHeight, elementOffsetTop]);
